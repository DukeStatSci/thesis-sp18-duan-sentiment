...
title: 'Personalization with Aspect-based Sentiment Analysis'
...
Overall introduction of the project.  
    ...
    - The ultimate goal of this thesis is to suggest a personalization tool/framework using aspect-based sentiment analysis of user-generated text.  
    - I expect to determine and implement a final model for the purpose and create a sketch of the personalization tool.  
    - By 12/7 at 9am: introduction, literature review, methodology.