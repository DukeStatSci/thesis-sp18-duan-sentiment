...
# Check-in {.unnumbered}
2017-12-7: This is the check point for Fall 2017. Current version includes a completed **Introduction**, completed sections in **Methodology** (*Data Preprocessing*, *Topic Extraction with LDA*), and correspondong sections in **Results** (*EDA*, *Topic Extraction with LDA*).  
